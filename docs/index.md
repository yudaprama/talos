...
Talos separates **admin operations** (issue, rotate, revoke, derive, verify) from **self-service
operations** (proof-of-possession self-revocation) so you can scale and secure each surface
independently.
...
- **[Configure](./operate/configure.md)** — configuration file, environment variables, and
  hot-reload behavior
- **[Deploy](./operate/deploy/index.md)** — Docker, Kubernetes, and split admin / self-service
  topologies
