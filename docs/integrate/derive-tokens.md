...
Derived tokens inherit permissions from the parent API key and are verified through the same admin
verify endpoint as issued and imported keys.
...
Derived tokens use the same admin verify endpoint as issued and imported API keys:
