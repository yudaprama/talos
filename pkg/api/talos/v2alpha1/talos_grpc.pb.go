...
const (
	...
	ApiKeys_AdminIngestUsage_FullMethodName                = "/talos.v2alpha1.ApiKeys/AdminIngestUsage"
	ApiKeys_AdminSetActorQuota_FullMethodName              = "/talos.v2alpha1.ApiKeys/AdminSetActorQuota"
	ApiKeys_AdminTopUpBalance_FullMethodName               = "/talos.v2alpha1.ApiKeys/AdminTopUpBalance"
	ApiKeys_AdminGetActorBalance_FullMethodName            = "/talos.v2alpha1.ApiKeys/AdminGetActorBalance"
...
type ApiKeysClient interface {
	...
	AdminIngestUsage(ctx context.Context, in *IngestUsageRequest, opts ...grpc.CallOption) (*IngestUsageResponse, error)
	// Set Actor Quota (fork)
	//
	// Sets an actor's metering quota and resets its remaining balance to the same
	// value (a fresh grant). Use to assign or change an actor's plan/tier (e.g.
	// free vs paid). Creates the balance row if absent. quota_micros 0 = unlimited
	// (gating off for this actor). Admin access only.
	AdminSetActorQuota(ctx context.Context, in *SetActorQuotaRequest, opts ...grpc.CallOption) (*ActorBalance, error)
	// Top Up Balance (fork)
	//
	// Adds credits to an actor's remaining balance without changing its quota.
	// Creates the balance row if absent (quota and remaining both set to the
	// amount). Admin access only.
	AdminTopUpBalance(ctx context.Context, in *TopUpBalanceRequest, opts ...grpc.CallOption) (*ActorBalance, error)
	// Get Actor Balance (fork)
	//
	// Reads an actor's current metering balance (quota + remaining). A missing
	// balance is reported as unlimited (quota 0, remaining 0). Admin access only.
	AdminGetActorBalance(ctx context.Context, in *GetActorBalanceRequest, opts ...grpc.CallOption) (*ActorBalance, error)
...
func (c *apiKeysClient) AdminIngestUsage(ctx context.Context, in *IngestUsageRequest, opts ...grpc.CallOption) (*IngestUsageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IngestUsageResponse)
	err := c.cc.Invoke(ctx, ApiKeys_AdminIngestUsage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiKeysClient) AdminSetActorQuota(ctx context.Context, in *SetActorQuotaRequest, opts ...grpc.CallOption) (*ActorBalance, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ActorBalance)
	err := c.cc.Invoke(ctx, ApiKeys_AdminSetActorQuota_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiKeysClient) AdminTopUpBalance(ctx context.Context, in *TopUpBalanceRequest, opts ...grpc.CallOption) (*ActorBalance, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ActorBalance)
	err := c.cc.Invoke(ctx, ApiKeys_AdminTopUpBalance_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiKeysClient) AdminGetActorBalance(ctx context.Context, in *GetActorBalanceRequest, opts ...grpc.CallOption) (*ActorBalance, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ActorBalance)
	err := c.cc.Invoke(ctx, ApiKeys_AdminGetActorBalance_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApiKeysServer interface {
	...
	// balance. Called by the external egent-metering service after each LLM call.
	// Idempotent via request_id. Admin access only.
	AdminIngestUsage(context.Context, *IngestUsageRequest) (*IngestUsageResponse, error)
	// Set Actor Quota (fork)
	//
	// Sets an actor's metering quota and resets its remaining balance to the same
	// value (a fresh grant). Use to assign or change an actor's plan/tier (e.g.
	// free vs paid). Creates the balance row if absent. quota_micros 0 = unlimited
	// (gating off for this actor). Admin access only.
	AdminSetActorQuota(context.Context, *SetActorQuotaRequest) (*ActorBalance, error)
	// Top Up Balance (fork)
	//
	// Adds credits to an actor's remaining balance without changing its quota.
	// Creates the balance row if absent (quota and remaining both set to the
	// amount). Admin access only.
	AdminTopUpBalance(context.Context, *TopUpBalanceRequest) (*ActorBalance, error)
	// Get Actor Balance (fork)
	//
	// Reads an actor's current metering balance (quota + remaining). A missing
	// balance is reported as unlimited (quota 0, remaining 0). Admin access only.
	AdminGetActorBalance(context.Context, *GetActorBalanceRequest) (*ActorBalance, error)
	// Batch Verify API Keys
	//
	// Verifies multiple credentials in a single request. Efficiently verifies up
	// to 100 credentials in parallel. Each credential is verified independently;
...
func (UnimplementedApiKeysServer) AdminIngestUsage(context.Context, *IngestUsageRequest) (*IngestUsageResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AdminIngestUsage not implemented")
}
func (UnimplementedApiKeysServer) AdminSetActorQuota(context.Context, *SetActorQuotaRequest) (*ActorBalance, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AdminSetActorQuota not implemented")
}
func (UnimplementedApiKeysServer) AdminTopUpBalance(context.Context, *TopUpBalanceRequest) (*ActorBalance, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AdminTopUpBalance not implemented")
}
func (UnimplementedApiKeysServer) AdminGetActorBalance(context.Context, *GetActorBalanceRequest) (*ActorBalance, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AdminGetActorBalance not implemented")
}
...
func _ApiKeys_AdminIngestUsage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IngestUsageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiKeysServer).AdminIngestUsage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApiKeys_AdminIngestUsage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiKeysServer).AdminIngestUsage(ctx, req.(*IngestUsageRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiKeys_AdminSetActorQuota_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetActorQuotaRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiKeysServer).AdminSetActorQuota(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApiKeys_AdminSetActorQuota_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiKeysServer).AdminSetActorQuota(ctx, req.(*SetActorQuotaRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiKeys_AdminTopUpBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TopUpBalanceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiKeysServer).AdminTopUpBalance(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApiKeys_AdminTopUpBalance_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiKeysServer).AdminTopUpBalance(ctx, req.(*TopUpBalanceRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiKeys_AdminGetActorBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetActorBalanceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiKeysServer).AdminGetActorBalance(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApiKeys_AdminGetActorBalance_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiKeysServer).AdminGetActorBalance(ctx, req.(*GetActorBalanceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ApiKeys_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AdminIngestUsage",
			Handler:    _ApiKeys_AdminIngestUsage_Handler,
		},
		{
			MethodName: "AdminSetActorQuota",
			Handler:    _ApiKeys_AdminSetActorQuota_Handler,
		},
		{
			MethodName: "AdminTopUpBalance",
			Handler:    _ApiKeys_AdminTopUpBalance_Handler,
		},
		{
			MethodName: "AdminGetActorBalance",
			Handler:    _ApiKeys_AdminGetActorBalance_Handler,
		},
		{
